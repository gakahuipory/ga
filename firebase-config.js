...
let authInitialized = false;  // 標記登入是否完成

// 節點座標
const nodePos = {
    A: { x: 450, y: 80 }, B: { x: 250, y: 150 }, C: { x: 150, y: 280 },
    D: { x: 200, y: 400 }, E: { x: 350, y: 480 }, F: { x: 550, y: 480 },
    G: { x: 750, y: 400 }, H: { x: 650, y: 280 }, I: { x: 700, y: 150 },
    J: { x: 800, y: 200 }, K: { x: 850, y: 350 }, L: { x: 700, y: 550 },
    M: { x: 450, y: 600 }
};
...
// ---------- 建立房間 ----------
function createRoom() {
    if (!authInitialized) { alert('登入中，請稍後'); return; }
